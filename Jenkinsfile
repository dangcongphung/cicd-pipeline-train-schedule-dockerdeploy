                            ...
                            sshPublisherDesc(
                                ...
                                transfers: [
                                    sshTransfer(
                                        ...
                                        remoteDirectory: '/tmp',
                                        execCommand: 'kubectl delete pod train ; sudo rm -rf /etc/containerd/train/* ; sudo yes | cp -rf /tmp/train.yaml /etc/containerd/train/ ; sudo rm -rf /tmp/* ; kubectl create -f /etc/containerd/train/train.yaml'
                                     )
                                ]
                            )
                        ]
